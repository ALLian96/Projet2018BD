...
class Ui_fct_comp_4(object):
    def setupUi(self, fct_comp_4):
        ...
        self.spinBox_fct_4_dossier = QtWidgets.QSpinBox(fct_comp_4)
        self.spinBox_fct_4_dossier.setObjectName("spinBox_fct_4_dossier")
        self.horizontalLayout.addWidget(self.spinBox_fct_4_dossier)

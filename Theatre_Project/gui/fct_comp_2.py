...
class Ui_fct_comp_2(object):
    def setupUi(self, fct_comp_2):
        ...
        self.comboBox_fct_comp2 = QtWidgets.QComboBox(fct_comp_2)
        self.comboBox_fct_comp2.setEditable(False)
        self.comboBox_fct_comp2.setObjectName("comboBox_fct_comp2")
        self.comboBox_fct_comp2.addItem("")
        self.comboBox_fct_comp2.addItem("")
        self.comboBox_fct_comp2.addItem("")
        self.horizontalLayout.addWidget(self.comboBox_fct_comp2)
        ...
        self.table_fct_comp_2.setColumnCount(4)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.table_fct_comp_2.setHorizontalHeaderItem(3, item)
    ...
    def retranslateUi(self, fct_comp_2):
        ...
        self.comboBox_fct_comp2.setCurrentText(_translate("fct_comp_2", "orchestre"))
        self.comboBox_fct_comp2.setItemText(0, _translate("fct_comp_2", "orchestre"))
        self.comboBox_fct_comp2.setItemText(1, _translate("fct_comp_2", "poulailler"))
        self.comboBox_fct_comp2.setItemText(2, _translate("fct_comp_2", "balcon"))
        ...
        item = self.table_fct_comp_2.horizontalHeaderItem(3)
        item.setText(_translate("fct_comp_2", "prixZone"))

...
class Ui_fct_comp_2(object):
    def setupUi(self, fct_comp_2):
        ...
        self.lineEdit_fct_comp_2 = QtWidgets.QLineEdit(fct_comp_2)
        self.lineEdit_fct_comp_2.setObjectName("lineEdit_fct_comp_2")
        self.horizontalLayout.addWidget(self.lineEdit_fct_comp_2)

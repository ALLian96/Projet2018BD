...
class Ui_fct_comp_2(object):
    def setupUi(self, fct_comp_2):
        ...
        self.comboBox = QtWidgets.QComboBox(fct_comp_2)
    ...
    def retranslateUi(self, fct_comp_2):
        ...
        self.comboBox.setItemText(0, _translate("fct_comp_2", "orchestre"))
        self.comboBox.setItemText(1, _translate("fct_comp_2", "poulailler"))
        self.comboBox.setItemText(2, _translate("fct_comp_2", "balcon"))

...
class Ui_fct_comp_3(object):
    def setupUi(self, fct_comp_3):
        ...
        self.comboBox_fct_comp_3 = QtWidgets.QComboBox(fct_comp_3)
        self.comboBox_fct_comp_3.setObjectName("comboBox_fct_comp_3")
        self.comboBox_fct_comp_3.addItem("")
        self.comboBox_fct_comp_3.addItem("")
        self.comboBox_fct_comp_3.addItem("")
        self.horizontalLayout.addWidget(self.comboBox_fct_comp_3)
    ...
    def retranslateUi(self, fct_comp_3):
        ...
        self.comboBox_fct_comp_3.setItemText(0, _translate("fct_comp_3", "orchestre"))
        self.comboBox_fct_comp_3.setItemText(1, _translate("fct_comp_3", "balcon"))
        self.comboBox_fct_comp_3.setItemText(2, _translate("fct_comp_3", "poulailler"))

...
class Ui_fct_comp_3(object):
    def setupUi(self, fct_comp_3):
        ...
        self.lineEdit_fct_comp_3 = QtWidgets.QLineEdit(fct_comp_3)
        self.lineEdit_fct_comp_3.setObjectName("lineEdit_fct_comp_3")
        self.horizontalLayout.addWidget(self.lineEdit_fct_comp_3)

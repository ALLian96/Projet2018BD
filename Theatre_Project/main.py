...
class AppWindow(QMainWindow):
    ...
    # TODO 5-6-7 : ajouter les fenetres (répertoire gui) et les actions (répertoire actions) correspondant aux 3 items de la partie 3, attention aux imports, à la génération des py des ui
